...
for ws in [2]:		# This is the window size
    data = np.loadtxt('Co_in_ZnS.q0.dos', skiprows=1, dtype='float')
    ...
    plt.title(r"Density of states of ZnS with $Cu_{Zn}$ impurity, q=0", fontsize=25)
    ...
    plt.text(0.1, 25.7, 'Fermi energy', rotation=90, fontsize=15)
