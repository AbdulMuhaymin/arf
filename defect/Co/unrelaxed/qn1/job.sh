...
mpirun pw.x -npool 10 -i 1.Co_in_ZnS.scf.qn1.unrlxd.in > 1.Co_in_ZnS.scf.qn1.unrlxd.out
mpirun pw.x -npool 10 -i 2.Co_in_ZnS.nscf.qn1.unrlxd.in > 2.Co_in_ZnS.nscf.qn1.unrlxd.out
...
tar -czvf 6.pdos_files.tar.gz Co_in_ZnS.qn1.unrlxd.pdos*
tar -tzvf 6.pdos_files.tar.gz
rm Co_in_ZnS.qn1.unrlxd.pdos*
rm Co_in_ZnS.qn1.unrlxd.pp
rm -rf out/*/*wfc*.hdf5