...
mpirun pw.x -npool 7 -i 2.Co_vac_in_ZnS.scf.q0.in > 2.Co_vac_in_ZnS.scf.q0.out

mpirun pw.x -npool 7 -i 3.Co_vac_in_ZnS.nscf.q0.in > 3.Co_vac_in_ZnS.nscf.q0.out
...
tar -czvf 6.pdos_files.tar.gz Co_vac_in_ZnS.q0.pdos*
tar -tzvf 6.pdos_files.tar.gz
rm Co_vac_in_ZnS.q0.pdos*
rm -rf out/*/*wfc*.hdf5