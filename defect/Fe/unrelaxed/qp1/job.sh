...
mpirun pw.x -npool 5 -i 1.Fe_in_ZnS.scf.qp1.unrlxd.in > 1.Fe_in_ZnS.scf.qp1.unrlxd.out
mpirun pw.x -npool 5 -i 2.Fe_in_ZnS.nscf.qp1.unrlxd.in > 2.Fe_in_ZnS.nscf.qp1.unrlxd.out
...
tar -czvf 6.pdos_files.tar.gz Fe_in_ZnS.qp1.unrlxd.pdos*
tar -tzvf 6.pdos_files.tar.gz
rm Fe_in_ZnS.qp1.unrlxd.pdos*
rm Fe_in_ZnS.qp1.unrlxd.pp
rm -rf out/*/*wfc*.hdf5
