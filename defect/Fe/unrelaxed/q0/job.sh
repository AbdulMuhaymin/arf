...
mpirun pw.x -npool 5 -i 1.Fe_in_ZnS.scf.q0.unrlxd.in > 1.Fe_in_ZnS.scf.q0.unrlxd.out
mpirun pw.x -npool 5 -i 2.Fe_in_ZnS.nscf.q0.unrlxd.in > 2.Fe_in_ZnS.nscf.q0.unrlxd.out
...
tar -czvf 6.pdos_files.tar.gz Fe_in_ZnS.q0.unrlxd.pdos*
tar -tzvf 6.pdos_files.tar.gz
rm Fe_in_ZnS.q0.unrlxd.pdos*
rm Fe_in_ZnS.q0.unrlxd.pp
rm -rf out/*/*wfc*.hdf5
