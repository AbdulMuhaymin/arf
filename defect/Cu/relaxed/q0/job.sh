...
###mpirun pw.x -npool 5 -i 1.Cu_in_ZnS.relax.q0.in > 1.Cu_in_ZnS.relax.q0.out
###mpirun pw.x -npool 10 -i 2.Cu_in_ZnS.scf.q0.in > 2.Cu_in_ZnS.scf.q0.out

mpirun pw.x -npool 10 -i 3.Cu_in_ZnS.nscf.q0.in > 3.Cu_in_ZnS.nscf.q0.out
...
tar -czvf 6.pdos_files.tar.gz Cu_in_ZnS.q0.pdos*
tar -tzvf 6.pdos_files.tar.gz
rm Cu_in_ZnS.q0.pdos*
rm -rf out/*/*wfc*.hdf5
