...
mpirun pw.x -npool 10 -i 1.Ni_in_ZnS.scf.q0.unrlxd.in > 1.Ni_in_ZnS.scf.q0.unrlxd.out
mpirun -np 1120 pw.x -npool 10 -i 2.Ni_in_ZnS.nscf.q0.unrlxd.in > 2.Ni_in_ZnS.nscf.q0.unrlxd.out
...
tar -czvf 6.pdos_files.tar.gz Ni_in_ZnS.q0.unrlxd.pdos*
tar -tzvf 6.pdos_files.tar.gz
rm Ni_in_ZnS.q0.unrlxd.pdos*
rm Ni_in_ZnS.q0.unrlxd.pp
rm -rf out/*/*wfc*.hdf5
