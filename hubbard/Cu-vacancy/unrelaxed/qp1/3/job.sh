...
mpirun pw.x -npool 13 -i 1.Cu_vac_in_ZnS.scf.qp1.unrlxd.U3.in > 1.Cu_vac_in_ZnS.scf.qp1.unrlxd.U3.out
mpirun pw.x -npool 13 -i 2.Cu_vac_in_ZnS.nscf.qp1.unrlxd.U3.in > 2.Cu_vac_in_ZnS.nscf.qp1.unrlxd.U3.out
...
rm out/*.hub*
###rm out/*/wfc*.hdf5
tar -czvf 6.pdos_files.tar.gz Cu_vac_in_ZnS.qp1.unrlxd.U3.pdos*
